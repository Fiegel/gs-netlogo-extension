...
/**
 * Implements the {@code add-edge-to-graph} and {@code aeg} commands.
 * 
 * Add a new edge to the specified graph.
 * 
 * <pre>
 * gs:add-edge-to-graph edgeAtt graphName
 * gs:aeg edgeAtt graphName
 * </pre>
 * 
 ...
 * @param graphName A String. The name of the graph in which the edge will be added.
 * 
 * @author Fiegel
 */

public class AddEdgeGraph extends DefaultReporter {
    ...
    public Syntax getSyntax() {
        int[] input = new int[] { Syntax.LinkType() | Syntax.ListType(), Syntax.StringType() };
    ...
    public Object report(Argument[] args, Context context) throws ExtensionException {
        ...
        try {
            GSManager.graphs.get(graphName).addEdge(edgeName, node1Name, node2Name, directed);
        }
